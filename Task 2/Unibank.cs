...
namespace Task_2
{
    internal class Unibank : AbstractBank
    {
        ...
        public Unibank (string cardNameAndSurname, string cardCode, int CVV, double cardBalance) : base(cardNameAndSurname, cardCode, CVV, cardBalance)
        {
        ...
        public override double cardMinus( double decrement)
        {
            ...
            double newValue = 0.985 * this.cardBalance - decrement;
            this.cardBalance= newValue;
