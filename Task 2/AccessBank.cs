...
namespace Task_2
{
    internal class AccessBank : AbstractBank
    {
        ...
        public AccessBank(string cardNameAndSurname, string cardCode, int CVV, double cardBalance) : base(cardNameAndSurname, cardCode, CVV, cardBalance)
        {
        ...
        public override double cardPlus(double increment)
        {
            ...
            double newValue = 0.997 * this.cardBalance + increment;
        ...
        public override double cardMinus(double decrement)
        {
            ...
            double newValue = 0.984 * this.cardBalance - decrement;
            this.cardBalance = newValue;
            return newValue;
        }
    }
